...
export function AutomationsManager() {
  ...
  return (
    <div className="p-6 space-y-8">
      ...
      {/* Stats Ribbon — DEMO PLACEHOLDER FIGURES (not live data) */}
      <div className="bg-slate-900 rounded-3xl p-6 text-white grid grid-cols-1 md:grid-cols-3 gap-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="absolute top-3 left-6 z-10">
          <span className="text-[9px] font-black uppercase tracking-widest text-amber-400/80 italic">Demo placeholder — not live data</span>
        </div>

...
import { useInvoice } from '../hooks/useFirebase';
    ...
    <div className="min-h-screen bg-cream py-12 px-4 md:px-0 relative overflow-hidden">
      ...
      <div className="max-w-xl mx-auto space-y-8 relative z-10">
        <div className="flex flex-col items-center mb-8 gap-2">
          ...
          <p className="text-[11px] font-black uppercase tracking-widest text-ochre italic">GrassRoots Mowing Co.</p>
        </div>
          ...
          <CardHeader className="bg-ochre/5 border-b border-ochre/10 pt-8">
            <div className="flex justify-between items-start">
              ...
              <div className="text-right">
                <p className="text-3xl font-black text-charcoal">${(invoice.totalAmount || 0).toFixed(2)}</p>
          ...
          <CardContent className="pt-8 space-y-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div className="text-right">
                ...
                <p className="text-[9px] font-black text-deep-red uppercase tracking-widest mt-2">Status: Not Paid</p>
              </div>
            </div>
            ...
            <div className="pt-8 space-y-4">
              {invoice.invoicePdfUrl && (
                <Button 
                  variant="outline"
                  className="w-full h-12 border-green-200 text-green-700 hover:bg-green-50 font-bold rounded-xl transition-all flex items-center justify-center gap-3 mb-2"
              ...
              >
                ...
                {processing ? 'Opening Payment...' : 'Pay Online (Card / Apple / Google)'}
              </Button>
        ...
        <div className="text-center space-y-2">
            ...
            <p className="text-[9px] font-black uppercase tracking-widest text-charcoal/20">GrassRoots Mowing Co. | ops@grassrootsmowing.co</p>
        </div>
      </div>
    </div>
  );

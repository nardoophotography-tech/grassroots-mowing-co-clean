    ...
    <div className="min-h-screen bg-[#FDFCFB]">
      <nav className="sticky top-0 z-50 border-b border-primary/20 bg-white/95 backdrop-blur-xl shadow-lg shadow-black/5">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center gap-4">
          ...
          <h1 className="text-lg font-black text-charcoal uppercase italic">Privacy Policy</h1>
        </div>
      </nav>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 space-y-8">
        <section className="space-y-4">
          <h2 className="text-3xl font-black text-charcoal uppercase italic">
            GrassRoots Mowing Co Privacy Policy
          </h2>
          <div className="prose prose-sm max-w-none space-y-4 text-charcoal font-medium leading-relaxed">
            <p>
              Customer details are used for quotes, bookings, invoices, service communication, and business records.
            </p>
            <p>
              Full legal privacy policy to be added.
            </p>
          </div>
        </section>

        <section className="bg-white border border-border rounded-2xl p-8">
          <h3 className="text-lg font-black text-primary uppercase italic mb-4">Contact Us</h3>
          <p className="text-sm text-clay font-medium">
            For privacy concerns or questions, please contact ops@grassrootsmowing.co
          </p>
        </section>
      </main>

...
import { useSettings } from '@/src/hooks/useFirebase';
  ...
  const packages = [
    {
      ...
      image: settings?.images?.town_block
    },
    {
      ...
      featured: true,
      image: settings?.images?.residential_standard
    },
    {
      id: 'premium_estate',
      name: 'Premium Estate',
      ...
      color: 'border-ochre',
      image: settings?.images?.premium_estate
    },
    {
      id: 'acreage',
    ...
    },
    {
      ...
      image: settings?.images?.placeholder
    }
  ];

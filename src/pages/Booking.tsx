...
export const Booking = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-12 relative overflow-hidden">
      ...
      <div className="max-w-xl mx-auto px-4 relative z-10 mt-12 grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        ...
        <div className="flex justify-between mb-16 relative">
          ...
          {[
            ...
            >
              ...
              <span className={cn(
                "hidden md:block text-[10px] mt-3 font-black uppercase tracking-[0.2em] transition-colors duration-300",

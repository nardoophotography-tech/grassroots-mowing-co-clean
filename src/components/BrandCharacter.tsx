...
export const BrandCharacter: React.FC = () => {
  return (
    ...
    >
      ...
      <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 bg-slate-900 text-white px-6 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.2em] shadow-xl border border-white/20 text-center">

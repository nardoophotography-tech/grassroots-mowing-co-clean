...
export const PRICING_RULES = {
  ...
  clientType: {
    'one-off': 1.15, // 15% surcharge for one-off
    'returning': 1.0,
    'ultimate-gold': 1.25, // 25% surcharge for gold premium service
    'real-estate': 1.15, // Inline with one-off client types
  },
  packageDetails: {
...
export const CLIENT_TYPE_LABELS: Record<string, string> = {
  'one-off': 'One-Off Client',
  'returning': 'Returning Client',
  'ultimate-gold': 'Ultimate Gold Member',
